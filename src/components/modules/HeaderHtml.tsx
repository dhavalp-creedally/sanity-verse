...
export default function HeaderHtml({ settings }: { settings: SettingsType } ) {
  ...
  return (
    <header
      className={`left-0 top-0 w-full z-[9999] bg-white py-7 lg:py-0 transition-all ease-in-out duration-300 ${
        ...
        <div className='w-full lg:w-9/12 h-0 lg:h-auto invisible lg:visible lg:flex items-center justify-between'>
            ...
            <div className='flex flex-wrap items-center gap-8.5 mt-7 lg:mt-0'>
              ...
              <div className="flex items-center gap-4.5">
                <button aria-label="Open search modal" className="flex items-center justify-center w-11 h-11 rounded-full bg-gray transition-all ease-linear duration-200 hover:bg-gray-2 hover:text-dark">
